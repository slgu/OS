...
@ -I /home/w4118/hmwk5-prog/flo-kernel/arch/arm/include
@ -I arch/arm/include/generated -I include
@ -I arch/arm/mach-goldfish/include
@ -iprefix /home/w4118/utils/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/
@ -D__USES_INITFINI__ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm
@ -D KBUILD_STR(s)=#s -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /home/w4118/utils/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/include
@ -include /home/w4118/hmwk5-prog/flo-kernel/include/linux/kconfig.h
