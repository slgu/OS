...
extern int kernel_fg_weight;
extern int kernel_bg_weight;
...
/* MODIFY WRR class' related field in a runqueu: */
struct wrr_rq {
	struct rq *rq;
...
extern void period_load_balance_wrr(struct rq *rq);
